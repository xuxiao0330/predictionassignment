...
4.I will train four model include:Random Forests,GBM, Trees and Linear, using defult 10-fold repeated cv method and pre-processing using center, scale and pca analysis. I will select the highest model with accuracy as my final prediction model.
```{r,eval=FALSE}
